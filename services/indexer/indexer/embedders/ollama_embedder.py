...
Ollama 0.4+ supports batched embedding natively — passing a list of
strings under 'input' returns a list of vectors in the same order.
We use httpx with HTTP/2 + retries; Ollama occasionally returns
transient 503 during model load on cold start.
"""
